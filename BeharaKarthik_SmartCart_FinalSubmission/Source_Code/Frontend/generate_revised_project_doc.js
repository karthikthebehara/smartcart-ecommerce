...
// Read logo as Base64 for embedding directly into HTML
const logoBase64 = fs.readFileSync(logoPath).toString('base64');
const logoDataUrl = `data:image/png;base64,${logoBase64}`;

// Helper to wrap page content with running header, single-line page border, and footer page numbering
function renderPage(content, pageNumText, showHeaderFooter = true) {
  if (!showHeaderFooter) {
    // Cover Page without header/footer or page number
    return `
    ...
    <div class="page-border">
      <div class="header-bar">
        <div class="header-left">
          ...
          <span class="header-brand">BLACKBUCKS ACADEMY</span>
        </div>
      ...
      <div class="footer-bar">
        <div class="footer-left">SmartCart – Full Stack E-Commerce Shopping Website</div>
        <div class="footer-right">${pageNumText}</div>
      </div>
    </div>
  </div>
  <div class="page-break"></div>`;
...
// Build HTML document with strict styling: Times New Roman, 14pt bold headings, 12pt justified body, single-line border
const htmlContent = `<!DOCTYPE html>
<html lang="en">
<head>
<meta charset="UTF-8">
<title>SmartCart - B.Tech Major Project Documentation</title>
<style>
  @page {
    size: A4;
    margin: 10mm;
...
<div class="cover-box">
  <div>
    <img src="${logoDataUrl}" style="height: 70px; width: 70px; margin-bottom: 10px;" alt="Logo" />
...
<div style="margin-top: 140px; display: flex; justify-content: space-between; text-align: center; font-weight: bold; font-size: 11pt;">
  <div>
...
<div style="margin-top: 100px; text-align: center; font-weight: bold; font-size: 11pt;">
  ________________________<br>
  External Examiner
</div>
`, "Page i")}
...
<div style="margin-top: 80px; text-align: right; font-weight: bold; font-size: 11pt;">
  BEHARA KARTHIK<br>
  Department of Computer Science & Engineering
</div>
`, "Page ii")}
...
<table>
  ...
  <tbody>
    <tr><td>1</td><td>Cover Page</td><td>Cover</td></tr>
    <tr><td>2</td><td>Bonafide Certificate</td><td>i</td></tr>
    <tr><td>3</td><td>Acknowledgement</td><td>ii</td></tr>
    <tr><td>4</td><td>Abstract</td><td>iii</td></tr>
    <tr><td>5</td><td>Table of Contents</td><td>iv</td></tr>
...
<!-- ================= MAIN CONTENT STARTS FROM PAGE 1 (Arabic Numerals) ================= -->

<!-- CHAPTER 6: INTRODUCTION (Page 1) -->
${renderPage(`
...
<!-- CHAPTER 7 & 8: PROBLEM STATEMENT & OBJECTIVES (Page 2) -->
${renderPage(`
...
<!-- CHAPTER 9 & 10: EXISTING & PROPOSED SYSTEM (Page 3) -->
${renderPage(`
...
<!-- CHAPTER 11: SYSTEM ARCHITECTURE (Page 4) -->
${renderPage(`
...
<div class="diagram-box">
  <svg width="650" height="380" viewBox="0 0 700 420" xmlns="http://www.w3.org/2000/svg">
...
<!-- CHAPTER 12: TECHNOLOGY STACK (Page 5) -->
${renderPage(`
...
<!-- CHAPTER 13 & 14: HARDWARE & SOFTWARE REQUIREMENTS (Page 6) -->
${renderPage(`
...
<!-- CHAPTER 15 & 16: REQUIREMENTS SPECIFICATION (Page 7) -->
${renderPage(`
...
<!-- CHAPTER 17: UML DIAGRAMS (Page 8) -->
${renderPage(`
<h1>CHAPTER 17: UNIFIED MODELING LANGUAGE (UML) DIAGRAMS</h1>

<h2>17.1 Use Case Diagram</h2>
<div class="diagram-box">
  <svg width="650" height="240" viewBox="0 0 650 280" xmlns="http://www.w3.org/2000/svg">
    <!-- Actors -->
...
<div class="diagram-box">
  <svg width="650" height="200" viewBox="0 0 650 230" xmlns="http://www.w3.org/2000/svg">
    <!-- User Class -->
...
<!-- CHAPTER 17 (Contd.): UML DIAGRAMS PART 2 (Page 9) -->
${renderPage(`
...
<!-- CHAPTER 18: DATABASE DESIGN (Page 10) -->
${renderPage(`
<h1>CHAPTER 18: DATABASE DESIGN & SCHEMAS</h1>

<h2>18.1 Entity-Relationship (ER) Diagram</h2>
<div class="diagram-box">
  <svg width="650" height="180" viewBox="0 0 650 220" xmlns="http://www.w3.org/2000/svg">
...
<!-- CHAPTER 19 & 20: MODULES & FRONTEND (Page 11) -->
${renderPage(`
...
<!-- CHAPTER 21 & 22: BACKEND & TESTING (Page 12) -->
${renderPage(`
...
<!-- CHAPTER 23: RESULTS & SCREENSHOTS (Page 13) -->
${renderPage(`
...
<!-- CHAPTERS 24 - 28: ADVANTAGES, LIMITATIONS, SCOPE, CONCLUSION, REFERENCES (Page 14) -->
${renderPage(`
...
// Generate Microsoft Word (.docx) Document using docx package
try {
  ...
  // Single line border properties for Word document section pages
  ...
  // Header configuration with Blackbucks logo in top-left
    ...
    children: [
      new Paragraph({
        children: [
          ...
          new TextRun({ text: "  BLACKBUCKS ACADEMY", bold: true, size: 20, color: "1E3A8A" }),
          new TextRun({ text: "  |  DEPARTMENT OF COMPUTER SCIENCE & ENGINEERING", bold: true, size: 18, color: "475569" })
        ],
        spacing: { after: 120 }
      })
    ]
  ...
  // Footer for preliminary pages (Roman Numerals)
  const preliminaryFooter = new Footer({
    children: [
      new Paragraph({
        children: [
          new TextRun({ text: "SmartCart – Full Stack E-Commerce Shopping Website  |  Page ", bold: true, size: 18 }),
          new TextRun({ children: [PageNumber.CONCEPTUAL], bold: true, size: 18 })
        ],
  ...
  // Footer for main content pages (Arabic Numerals starting at 1)
  ...
  const doc = new Document({
    ...
    sections: [
      ...
      // SECTION 2: PRELIMINARY PAGES (Roman Numerals i, ii, iii, iv)
      {
        properties: {
          pageBorders: singleLineBorder,
        ...
        children: [
          ...
          new Paragraph({ text: "1. Cover Page (Cover)\n2. Certificate (i)\n3. Acknowledgement (ii)\n4. Abstract (iii)\n5. Table of Contents (iv)\n6. Introduction (1)\n7. Problem Statement (2)\n8. Objectives (2)\n9. Existing System Analysis (3)\n10. Proposed System (3)\n11. System Architecture (4)\n12. Technology Stack (5)\n13. Hardware Requirements (6)\n14. Software Requirements (6)\n15. Functional Requirements (7)\n16. Non-Functional Requirements (7)\n17. UML Diagrams (8)\n18. Database Design (10)\n19. Module Specifications (11)\n20. Frontend Implementation (11)\n21. Backend Implementation (12)\n22. Software Testing (12)\n23. Results & Screenshots (13)\n24. Advantages (14)\n25. Limitations (14)\n26. Future Scope (14)\n27. Conclusion (14)\n28. References (14)" })
        ]
      },

      // SECTION 3: MAIN CONTENT PAGES (Arabic Numerals starting from Page 1)
      {
        properties: {
          pageBorders: singleLineBorder,
          pageNumberStart: 1,
        ...
        children: [
          ...
          // Chapter 7 & 8: Problem Statement & Objectives
          new Paragraph({ text: "CHAPTER 7: PROBLEM STATEMENT", heading: HeadingLevel.HEADING_1 }),
          ...
          new Paragraph({ text: "CHAPTER 8: OBJECTIVES", heading: HeadingLevel.HEADING_1 }),
