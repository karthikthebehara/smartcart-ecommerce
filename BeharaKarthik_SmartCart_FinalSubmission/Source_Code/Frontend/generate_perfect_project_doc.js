...
// Helper to render a page with header (Blackbucks logo + "Blackbucks"), page content, single border, and centered footer page number
...
// Complete HTML document template adhering strictly to formatting guidelines
...
<div class="cover-box">
  ...
  <div style="border-top: 1px solid #000000; padding-top: 12px;">
...
<!-- ================= PRELIMINARY PAGES (Centered Roman Numerals) ================= -->
...
<!-- ================= MAIN CONTENT PAGES (Centered Arabic Numerals starting from 1) ================= -->
