...
<div class="diagram-box">
  <svg width="650" height="150" viewBox="0 0 650 180" xmlns="http://www.w3.org/2000/svg">
...
<div class="diagram-box">
  <svg width="650" height="260" viewBox="0 0 650 340" xmlns="http://www.w3.org/2000/svg">
    <!-- Start Node -->
    <circle cx="325" cy="18" r="9" fill="#000000"/>
    <text x="325" y="37" text-anchor="middle" font-size="9" font-weight="bold">Start</text>
    <line x1="325" y1="40" x2="325" y2="60" stroke="#000000" stroke-width="1.5"/>

    <!-- Action 1 -->
    <rect x="230" y="60" width="190" height="32" rx="6" fill="#eff6ff" stroke="#1e40af" stroke-width="1.5"/>
    <text x="325" y="80" text-anchor="middle" font-size="9.5" font-weight="bold">Browse Catalog & Add to Cart</text>
    <line x1="325" y1="92" x2="325" y2="115" stroke="#000000" stroke-width="1.5"/>

    <!-- Decision 1 -->
    <polygon points="325,115 365,133 325,151 285,133" fill="#fffbeb" stroke="#d97706" stroke-width="1.5"/>
    <text x="325" y="136" text-anchor="middle" font-size="8.5" font-weight="bold">Checkout?</text>
    <line x1="365" y1="133" x2="440" y2="133" stroke="#000000" stroke-width="1.5"/>
    <text x="395" y="126" font-size="8.5" fill="#dc2626">No</text>
    <line x1="440" y1="133" x2="440" y2="76" stroke="#000000" stroke-width="1.5"/>
    <line x1="440" y1="76" x2="420" y2="76" stroke="#000000" stroke-width="1.5"/>

    <line x1="325" y1="151" x2="325" y2="175" stroke="#000000" stroke-width="1.5"/>
    <text x="333" y="165" font-size="8.5" fill="#16a34a">Yes</text>

    <!-- Action 2 -->
    <rect x="215" y="175" width="220" height="32" rx="6" fill="#f0f9ff" stroke="#0284c7" stroke-width="1.5"/>
    <text x="325" y="195" text-anchor="middle" font-size="9.5" font-weight="bold">Enter Shipping & Payment Details</text>
    <line x1="325" y1="207" x2="325" y2="230" stroke="#000000" stroke-width="1.5"/>

    <!-- Action 3 -->
    <rect x="210" y="230" width="230" height="32" rx="6" fill="#f0fdf4" stroke="#059669" stroke-width="1.5"/>
    <text x="325" y="250" text-anchor="middle" font-size="9.5" font-weight="bold">Dispatch Order Request (POST API)</text>
    <line x1="325" y1="262" x2="325" y2="285" stroke="#000000" stroke-width="1.5"/>

    <!-- Action 4 -->
    <rect x="200" y="285" width="250" height="32" rx="6" fill="#fef3c7" stroke="#b45309" stroke-width="1.5"/>
    <text x="325" y="305" text-anchor="middle" font-size="9.5" font-weight="bold">Save in MySQL & Display Order Receipt</text>
    <line x1="325" y1="317" x2="325" y2="330" stroke="#000000" stroke-width="1.5"/>

    <!-- End Node -->
    <circle cx="325" cy="336" r="6" fill="#ffffff" stroke="#000000" stroke-width="1.5"/>
    <circle cx="325" cy="336" r="3.5" fill="#000000"/>
  </svg>
  <div class="diagram-caption">Figure 12.4: Activity Diagram for SmartCart User Checkout Workflow</div>
</div>
`, "10")}
...
<div class="diagram-box">
  ...
  <div class="diagram-caption">Figure 12.5: Component Diagram of SmartCart System</div>
</div>
...
<!-- CHAPTER 18: RESULTS & EXECUTION SCREENSHOTS - PART 1 (Page 17) -->
${renderPage(`
...
<div class="screenshot-figure">
  ...
  <div class="screenshot-caption">Figure 18.1: SmartCart Home Page & Hero Banner Interface</div>
</div>

<div class="screenshot-figure">
  <img src="${authImgUrl}" class="screenshot-img" alt="Login Screenshot" />
  <div class="screenshot-caption">Figure 18.2: User Authentication & Login Interface</div>
</div>

<div class="screenshot-figure">
  <img src="${productImgUrl}" class="screenshot-img" alt="Product Catalog Screenshot" />
  <div class="screenshot-caption">Figure 18.3: Product Catalog with Live Search & Price Sorting</div>
</div>
`, "17")}

<!-- CHAPTER 18: RESULTS & EXECUTION SCREENSHOTS - PART 2 (Page 18) -->
${renderPage(`
<div class="screenshot-figure">
  <img src="${cartImgUrl}" class="screenshot-img" alt="Checkout Screenshot" />
  <div class="screenshot-caption">Figure 18.4: Multi-Step Checkout & Order Summary Interface</div>
</div>

<div class="screenshot-figure">
  <img src="${mysqlImgUrl}" class="screenshot-img" alt="MySQL Database Screenshot" />
  <div class="screenshot-caption">Figure 18.5: MySQL Workbench Schema & Query Execution Results</div>
</div>

<div class="screenshot-figure">
  <img src="${backendImgUrl}" class="screenshot-img" alt="Backend REST API Screenshot" />
  <div class="screenshot-caption">Figure 18.6: Live Spring Boot REST API JSON Output (Port 8080)</div>
</div>

<div class="screenshot-figure">
  <img src="${frontendImgUrl}" class="screenshot-img" alt="Frontend React Categories Screenshot" />
  <div class="screenshot-caption">Figure 18.7: React Frontend Category Navigation Interface (Port 3000)</div>
</div>
`, "18")}
...
try {
  ...
  console.log('PDF created successfully with Activity Diagram:', pdfPathBbd1);
} catch (err) {
...
try {
  ...
  function getImgBuffer(filename) {
    const p = path.join(__dirname, 'OUTPUT SCREENS', filename);
    if (fs.existsSync(p)) return fs.readFileSync(p);
    return null;
  }

  const heroBuf = getImgBuffer('HERO PAGE.png');
  const authBuf = getImgBuffer('User Authentication.png');
  const prodBuf = getImgBuffer('Product Catalog.png');
  const cartBuf = getImgBuffer('Shopping Cart.png');
  const mysqlBuf = getImgBuffer('MySQL Database.png');
  const backendBuf = getImgBuffer('Backend.png');
  const frontendBuf = getImgBuffer('Frontend.png');
    ...
    sections: [
...

      {
        ...
        children: [
          ...
          new Paragraph({ text: "CHAPTER 18: RESULTS & EXECUTION SCREENSHOTS", heading: HeadingLevel.HEADING_1 }),
          createImgParagraph(heroBuf, "Figure 18.1: SmartCart Home Page & Hero Banner Interface"),
          createImgParagraph(authBuf, "Figure 18.2: User Authentication & Login Interface"),
          createImgParagraph(prodBuf, "Figure 18.3: Product Catalog with Live Search & Price Sorting"),
          createImgParagraph(cartBuf, "Figure 18.4: Multi-Step Checkout & Order Summary Interface"),
          createImgParagraph(mysqlBuf, "Figure 18.5: MySQL Workbench Schema & Query Execution Results"),
          createImgParagraph(backendBuf, "Figure 18.6: Live Spring Boot REST API JSON Output (Port 8080)"),
          createImgParagraph(frontendBuf, "Figure 18.7: React Frontend Category Navigation Interface (Port 3000)"),
          new PageBreak(),
  ...
  Packer.toBuffer(doc).then(buffer => {
    ...
    console.log('DOCX created successfully with Activity Diagram & screenshots:', docxPathBbd1);
  });
} catch (err) {
